...
There are certain steps that are different between PC and Mac.  When I tried to follow instructions by folks that were using PCs for setting up TensorFlow 2 (TF2), Object Detection, etc. I would end up with errors.
